...
enum SeedData {
    ...
    static func seedIfNeeded(in context: ModelContext) {
        ...
        let e1 = Event(title: "St. Louis Cardinals @ Chicago Cubs", date: date(today, hour: 13), venue: "Wrigley Field", watchLocation: .stadium)
        ...
        let e2 = Event(title: "Los Angeles Lakers @ Chicago Bulls", date: date(today, hour: 19), venue: "United Center", watchLocation: .tv)
        ...
        let e3 = Event(title: "Green Bay Packers @ Chicago Bears", date: date(yesterday, hour: 12), venue: "Soldier Field", watchLocation: .stadium)
        ...
        let e4 = Event(title: "New York Yankees @ Boston Red Sox", date: date(tomorrow, hour: 18), venue: "Fenway Park", watchLocation: .stadium)
        ...
        let e5 = Event(title: "Chicago Blackhawks @ Detroit Red Wings", date: date(twoDaysAgo, hour: 19), venue: "Little Caesars Arena", watchLocation: .tv)
