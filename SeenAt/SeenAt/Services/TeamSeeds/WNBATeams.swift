...
enum WNBATeams {
    @MainActor static var all: [Team] { [
        ...
        Team(name: "Golden State Valkyries", abbreviation: "GSV", sport: "wnba", isBuiltIn: true, primaryColorHex: "#2D2A26", secondaryColorHex: "#8A6B37"),
        ...
        Team(name: "Portland Fire", abbreviation: "POR", sport: "wnba", isBuiltIn: true, primaryColorHex: "#E03A3E", secondaryColorHex: "#000000"),
        Team(name: "Seattle Storm", abbreviation: "SEA", sport: "wnba", isBuiltIn: true, primaryColorHex: "#2C5234", secondaryColorHex: "#8BC53F"),
        Team(name: "Toronto Tempo", abbreviation: "TOR", sport: "wnba", isBuiltIn: true, primaryColorHex: "#6CACE4", secondaryColorHex: "#000000"),
